...
#if __ANDROID__
                reading.FlightsAscended, reading.FlightsDescended, reading.Rate, reading.SteppingGain, reading.SteppingLoss, reading.StepsAscended, reading.StepsDescended, reading.TotalGain, reading.TotalLoss
#elif __IOS__
                (long)reading.FlightsAscended, (long)reading.FlightsDescended, reading.Rate, (long)reading.SteppingGain, (long)reading.SteppingLoss, (long)reading.StepsAscended, (long)reading.StepsDescended, (long)reading.TotalGain, (long)reading.TotalLoss
#elif WINDOWS_PHONE_APP
                reading.FlightsAscended, reading.FlightsDescended, reading.Rate, reading.SteppingGain, reading.SteppingLoss, reading.StepsAscended, reading.StepsDescended, reading.TotalGain, reading.TotalLoss
#endif
                );
